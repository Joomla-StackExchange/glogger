...
/**
 * Item Model for glogger_details.
 *
 * @package     Glogger
 * @subpackage  Models
 */
class GloggerModelGLogger_Details extends JModelAdmin
{
	/**
	 * @var        string    The prefix to use with controller messages.
	 * @since   1.6
	 */
	protected $text_prefix = 'COM_GLOGGER';
	 ...
	 * @since    3.2
	 */
	public $typeAlias = 'com_glogger.glogger_details';
	 ...
	 */
	public function getTable($type = 'GLogger_Details', $prefix = 'GloggerTable', $config = array())
	{
	...
	public function hit($pk = 0)
	{
		...
		if ($hitcount)
		{
			$pk = (!empty($pk)) ? $pk : (int) $this->getState('glogger_details.id');
